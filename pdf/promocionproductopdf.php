...
//Iniciando un nuevo pdf
        ...
        $pdf->SetTitle('Informe de Promociones de Productos');
        ...
        $pdf->Cell(70,6,'LISTA DE PROMOCIONES DE PRODUCTOS',0,0,'C');
        ...
        $pdf->Cell(40,6,'PROMOCION',1,0,'C',1);
        ...
        // filtro de promocionproducto
        $filtropromocionproducto=($_POST['filtropromocionproducto']);

        $sqlpromocionproducto = ("SELECT  pr.nom_promocion, p.id_producto, p.nom_producto, pp.id_promociones_productos, pp.cantidad FROM TBL_promociones_productos pp
                                ...
                                inner JOIN TBL_producto p ON p.id_producto = pp.id_producto
                                 WHERE pr.nom_promocion LIKE'%".$filtropromocionproducto."%'");
        

        //$sqlTrabajadores = ("SELECT * FROM trabajadores");
        $query = mysqli_query($conexion, $sqlpromocionproducto);

        while ($dataRow = mysqli_fetch_array($query)) {
                $pdf->Cell(40,6,($dataRow['nom_promocion']),1,0,'C');
                $pdf->Cell(45,6,$dataRow['nom_producto'],1,0,'C');
                $pdf->Cell(60,6, $dataRow['cantidad'],1,1,'C');
            }
